package ch.ilv.zufallsgenerator.security;
...
public class AuthenticationRoleConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private static Collection<? extends GrantedAuthority> extractResourceRoles(final Jwt jwt) {
        ...
        if (resourceAccess != null) {
            Map<String, Collection<String>> zuffallsgeneratorApp = (Map<String, Collection<String>>) resourceAccess.get("zuffallsgeneratorApp");
          if ((resourceRoles = zuffallsgeneratorApp.get("roles")) != null) {
